...
fitThresholdContourIncrDecrData('subj','11046','dataDate','20210914','subProject','IncrDecr2','condition','Size_2', ...
    'norm',false','corrGuess',true,'reflIn',true,'reflOut',false,'scaleDecr',false,'constrainedSlopeFits',true,'lockSlope',true, ...
    'defocusDiopters',0.05);
fitThresholdContourIncrDecrData('subj','11046','dataDate','20210914','subProject','IncrDecr2','condition','Size_2', ...
    'norm',false','corrGuess',true,'reflIn',false,'reflOut',false,'scaleDecr',true,'constrainedSlopeFits',true,'lockSlope',true, ...
    'defocusDiopters',0.05);