% RunAllPFFits
%
% Run all the threshold contour fits.  Must happen after PF fitting.
...
fitThresholdContourIncrDecrData('subj','11046','dataDate','20200131','subProject','IncrDecr1','condition','Separation_1', ...
    'norm',false','corrGuess',true,'reflIn',false,'reflOut',false,'scaleDecr',false,'constrainedSlopeFits',true,'lockSlope',true, ...
    'defocusDiopters',0.05,'pupilDiam',7,'computationalName','7_9_0','AggregateFitName','Aggregated');
fitThresholdContourIncrDecrData('subj','11046','dataDate','20200131','subProject','IncrDecr1','condition','Separation_1', ...
    'norm',false','corrGuess',true,'reflIn',false,'reflOut',false,'scaleDecr',false,'constrainedSlopeFits',true,'lockSlope',true, ...
    'defocusDiopters',0.10,'pupilDiam',7,'computationalName','7_9_0','AggregateFitName','Aggregated');
...
%% 2021-09-14
%
%  7x9 stimulus replication, 11046
...
fitThresholdContourIncrDecrData('subj','11046','dataDate','20211026','subProject','IncrDecr4','condition','Size_1', ...
    'norm',false','corrGuess',true,'reflIn',false,'reflOut',false,'scaleDecr',false,'constrainedSlopeFits',true,'lockSlope',true, ...
    'defocusDiopters',0.05,'pupilDiam',7,'theLim',2,'computationalName','7_9_0','AggregateFitName','Aggregated');
fitThresholdContourIncrDecrData('subj','11046','dataDate','20211026','subProject','IncrDecr4','condition','Size_1', ...
    'norm',false','corrGuess',true,'reflIn',false,'reflOut',false,'scaleDecr',false,'constrainedSlopeFits',true,'lockSlope',true, ...
    'defocusDiopters',0.10,'pupilDiam',7,'theLim',2,'computationalName','7_9_0','AggregateFitName','Aggregated');
fitThresholdContourIncrDecrData('subj','11046','dataDate','20211026','subProject','IncrDecr4','condition','Size_1', ...
    'norm',false','corrGuess',true,'reflIn',false,'reflOut',false,'scaleDecr',true,'constrainedSlopeFits',true,'lockSlope',true, ...
    'defocusDiopters',0.05,'pupilDiam',7,'theLim',2,'computationalName','7_9_0','AggregateFitName','Aggregated');
fitThresholdContourIncrDecrData('subj','11046','dataDate','20211026','subProject','IncrDecr4','condition','Size_1', ...
